...
with h5py.File(output_file, "w") as hdf:
    ...
    hdf.create_dataset("z", data=z, dtype=data_format["z"])
    hdf.create_dataset("Wx", data=Wx, dtype=data_format["Wx"])
    hdf.create_dataset("Wy", data=Wy, dtype=data_format["Wy"])
    hdf.create_dataset("Wz", data=Wz, dtype=data_format["Wz"])
