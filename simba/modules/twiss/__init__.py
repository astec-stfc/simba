...
class Twiss(DeprecatedMethodAliases, BaseModel):
    """
    ...
    _DEPRECATED_METHOD_ALIASES = {
        "elegantData": "elegant_data",
        "elegantTwiss": "elegant_twiss",
        "read_GPT_twiss_files": "read_gpt_twiss_files",
        "read_HDF5_twiss_file": "read_hdf5_twiss_file",
        "save_HDF5_twiss_file": "save_hdf5_twiss_file",
        "set_E0": "set_e0",
    }
    ...
    def read_sdds_file(self, filename: str, ascii: bool = False) -> Dict[str, float]:
        ...
        sddsobject.elegant_twiss = munch.Munch()
        elegant.read_sdds_file(sddsobject, filename, ascii)
        return sddsobject.elegant_twiss
...
__getattr__ = deprecated_aliases(
    ...
    globals(),
    {
        "initialTwiss": "InitialTwiss",
        "twiss": "Twiss",
        "twissParameter": "TwissParameter",
    },
)
