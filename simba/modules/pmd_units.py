...
class PmdUnit(DeprecatedMethodAliases):
    """
    ...
    def __init__(self, unitSymbol="", unitSI=0, unitDimension=(0, 0, 0, 0, 0, 0, 0)):
        ...
        if unitSI == 0:
            if unitSymbol in known_unit:
                ...
                unitSI = u.unit_si
                unitDimension = u.unit_dimension
            else:
...
known_unit = {
    ...
    "c": PmdUnit("vel/c", c_light, "velocity"),
...
def write_unit_h5(h5, u):
    ...
    h5.attrs["unitSI"] = u.unit_si
    h5.attrs["unitDimension"] = u.unit_dimension
    h5.attrs["unitSymbol"] = u.unit_symbol
