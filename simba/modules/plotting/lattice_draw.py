...
class RectangleElement(DeprecatedMethodAliases, pg.GraphicsObject):

    _DEPRECATED_METHOD_ALIASES = {
        "boundingRect": "bounding_rect",
        "generatePicture": "generate_picture",
    ...
    def bounding_rect(self):
        ...
        return QtCore.QRectF(self.picture.bounding_rect())
...
class LineElement(DeprecatedMethodAliases, pg.GraphicsObject):
...
class LatticeDraw(DeprecatedMethodAliases):

    # Legacy names, served with a FutureWarning by the mixin, which
    # also warns if a subclass overrides one under its old name.
    _DEPRECATED_METHOD_ALIASES = {
        "defineElements": "define_elements",
    }
...
if __name__ == "__main__":
    ...
    elemdata = data_object.latticeDict
