...
def get_min_vol_ellipse(P=None, tolerance=0.01):
...
if __name__ == "__main__":
    ...
    (center, radii, rotation, hull_p) = ET.get_min_vol_ellipse(q, 0.001)
    ...
    ax.scatter(hull_p[:, 0], hull_p[:, 1], color="r", s=10)
...
__getattr__ = deprecated_aliases(
    ...
    globals(),
    {
        "getEllipsoidVolume": "get_ellipsoid_volume",
        "getMinVolEllipse": "get_min_vol_ellipse",
        "plotEllipsoid": "plot_ellipsoid",
