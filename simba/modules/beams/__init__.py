...
class BeamGroup(DeprecatedMethodAliases, BaseModel):
    """
...
class Beam(DeprecatedMethodAliases, BaseModel):
    """
    ...
    _DEPRECATED_METHOD_ALIASES = {
        "Particles": "particles",
        "read_HDF5_beam_file": "read_hdf5_beam_file",
        "read_SDDS_beam_file": "read_sdds_beam_file",
        "rotate_beamXZ": "rotate_beam_xz",
        "unrotate_beamXZ": "unrotate_beam_xz",
        "write_HDF5_beam_file": "write_hdf5_beam_file",
        "write_SDDS_beam_file": "write_sdds_beam_file",
    }
    ...
    if use_matplotlib:
        ...
        def plot_screen_image(self, **kwargs):
            return plot.plot_screen_image(self, **kwargs)
    ...
    def rotate_beam_xz(self, theta, preOffset=[0, 0, 0], postOffset=[0, 0, 0]):
        hdf5.rotate_beam_xz(self, theta, preOffset=preOffset, postOffset=postOffset)

    def unrotate_beam_xz(self):
        hdf5.unrotate_beam_xz(self)
...
__getattr__ = deprecated_aliases(
    ...
    globals(),
    {
        "beam": "Beam",
        "beamGroup": "BeamGroup",
        "load_HDF5_summary_file": "load_hdf5_summary_file",
        "particlesGroup": "ParticlesGroup",
        "save_HDF5_summary_file": "save_hdf5_summary_file",
        "stats": "Stats",
