...
def read_cheetah_beam_file(self, filename, beam_energy, zstart=0, s=0, ref_index=None):
    ...
    interpret_cheetah_particle_beam(self, parray, beam_energy, zstart=zstart, s=s, ref_index=ref_index)


def interpret_cheetah_particle_beam(self, parray, zstart=0, s=0, ref_index=None):
...
__getattr__ = deprecated_aliases(
    ...
    globals(),
    {
        "interpret_cheetah_ParticleBeam": "interpret_cheetah_particle_beam",
    },
)
