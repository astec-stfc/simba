...
def plot_screen_image(
    ...
    **kwargs,
    ...
    # --- Compute PDF ---
    if fast_kde_installed and not use_scipy:
...
__getattr__ = deprecated_aliases(
    ...
    globals(),
    {
        "fastKDE_installed": "fast_kde_installed",
        "getScreenImage": "get_screen_image",
        "plotScreenImage": "plot_screen_image",
    },
)
