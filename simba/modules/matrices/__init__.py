...
class Matrices(DeprecatedMethodAliases, munch.Munch):
    ...
    _DEPRECATED_METHOD_ALIASES = {
        ...
        "generate_R_matrix": "generate_r_matrix",
        "individualR": "individual_r",
    }
    ...
    def cumulative_r(self, combined=False):
        cR = []
        if combined:
            ir = list(reversed(self.flatten1(self.individual_r())))
            r = ir[0]
            for mat in ir[1:]:
                r = np.dot(mat, r)
                cR.append(r)
