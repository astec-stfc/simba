...
def write_opal_field_file(
    ...
    :class:`~simba.Modules.Fields.FieldMap` object provided.
    ...
    Parameters
    ----------
    self: :class:`~simba.Modules.Fields.FieldMap`
        The field object
    frequency: float | None
    ...
    if isinstance(self.field_type, bytes):
        self.field_type = self.field_type.decode("utf-8")
...
def read_opal_field_file(
    ...
    """
    Read an OPAL field file and convert it into a :class:`simba.Modules.Fields.FieldMap` object
