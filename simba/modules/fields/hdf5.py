...
def read_hdf5_field_file(self, filename: str) -> str:
    """
    Read an HDF5 field file and convert it into a :class:`simba.Modules.Fields.FieldMap` object
...
def write_hdf5_field_file(self):
    """
    Write the :class:`simba.Modules.Fields.FieldMap` object to an HDF5 file.
